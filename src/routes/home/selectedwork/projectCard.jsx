      ...
      <Link to={route} className="space-y-5 w-full">
        ...
        <section className='w-1/2 text-nao-white space-y-5'>
          <div className='flex items-center space-x-2 cursor-pointer'>
            <p className='text-lg md:text-3xl whitespace-nowrap font-[450]'>{title}</p>
            <motion.div className="hover:translate-x-2 transition-all ease-in-out duration-300">
          ...
          <p className='text-sm md:text-2xl font-[450]'>
            {text}
          </p>
        </section>
      </Link>
